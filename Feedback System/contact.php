...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Hostel No 12<br>Ambala, India 133207<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 7645961872</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">rahulkumarncti45@gmail.com</a>
                </p>
                ...
                <ul class="list-unstyled list-inline list-social-icons">
                    ...
                    <li>
                        <a href="www.linkedin.com/in/rahul-kumar76"><i class="fa fa-linkedin-square fa-2x"></i></a>
                    </li>
                    <li>
